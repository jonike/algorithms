...
bool DEQ(double a, double b){return abs(a - b) < 0.000000000001;}
double dot(const vertex& l, const vertex& r){return l.first * r.first + l.second * r.second;}
double cross(const vertex& v1, const vertex& v2){return v1.first * v2.second - v1.second * v2.first;}
double dist(const vertex& a, const vertex& b){
    return sqrt((a.first - b.first) * (a.first - b.first) + (a.second - b.second) * (a.second - b.second));
}
double angle_of(const vertex& p, const vertex& a, const vertex& b){
...
int point_in_polygon(const vector<vertex>& vertices, const vertex& p){
    double angle = 0;
